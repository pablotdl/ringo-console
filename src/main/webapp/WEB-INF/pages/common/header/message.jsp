...
<div class="dropdown left">
	...
	<a class="dropdown-toggle head-button-link" data-toggle="dropdown"
		href="#"><span class="notice-new">3</span></a>
	...
	<div class="dropdown-menu pull-right messages-list">
		...
		<div class="notice-message">
			<a href="#" class="box">
				<div class="avatar">
					<img src="<c:url value="/images/avatar-2.png" />" alt="">
				</div>
				<div class="info">
		...
		<div class="notice-message">
			<a href="#" class="box">
				<div class="avatar">
					<img src="<c:url value="/images/avatar-3.png" />" alt="">
				</div>
				<div class="info">
		...
		<div class="notice-message">
			<a href="#" class="box">
				<div class="avatar">
					<img src="<c:url value="/images/avatar-4.png" />" alt="">
				</div>
				<div class="info">
