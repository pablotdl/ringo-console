...
<div class="dropdown left">
	<a class="dropdown-toggle head-button-link notification"
		data-toggle="dropdown" href="#"><span class="notice-new">2</span></a>
	...
	<div class="dropdown-menu pull-right messages-list">
		...
		<div class="notice-message">
			<a href="#" class="box">
				<div class="avatar">
					<img src="<c:url value="/images/avatar-5.png" />" alt="">
				</div>
				<div class="info">
					...
					<div class="text">
						Followed <span class="follow-link">Dennis Salvatier</span>
					</div>
				</div>
				<div class="clearfix"></div>
			</a>
		...
		<div class="notice-message">
			<a href="#" class="box">
				<div class="avatar">
					<img src="<c:url value="/images/avatar-6.png" />" alt="">
				</div>
				<div class="info">
					...
					<div class="clearfix"></div>
					<div class="text">
						Commented on <span class="comment-link">Angry Cloud</span>
					</div>
				</div>
				<div class="clearfix"></div>
			</a>
		...
		<div class="notice-message">
			<a href="#" class="box">
				<div class="avatar">
					<img src="<c:url value="/images/avatar-7.png" />" alt="">
				</div>
				<div class="info">
					...
					<div class="clearfix"></div>
					<div class="text">
						Liked <span class="like-link">Overnight work</span>
					</div>
				</div>
				<div class="clearfix"></div>
			</a>
